...
tape( 'the function has an arity of 10', function test( t ) {
	t.strictEqual( gwxsy.length, 10, 'has expected arity' );
	t.end();
});
...
tape( 'the function subtracts elements of `y` from the corresponding elements of `x` and assigns the results to elements in `w`', function test( t ) {
	...
	gwxsy( x.length, x, 1, 0, y, 1, 0, w, 1, 0 );
...
tape( 'the function subtracts elements of `y` from the corresponding elements of `x` and assigns the results to elements in `w` (accessors)', function test( t ) {
	...
	gwxsy( x.length, toAccessorArray( x ), 1, 0, toAccessorArray( y ), 1, 0, toAccessorArray( w ), 1, 0 );
	t.deepEqual( w, expected, 'returns expected value' );
...
tape( 'the function returns a reference to the output array', function test( t ) {
	...
	w = zeros( x.length );
	out = gwxsy( x.length, x, 1, 0, y, 1, 0, w, 1, 0 );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `w` unchanged', function test( t ) {
	...
	gwxsy( 0, x, 1, 0, y, 1, 0, w, 1, 0 );
	t.deepEqual( w, expected, 'returns expected value' );

	gwxsy( -4, x, 1, 0, y, 1, 0, w, 1, 0 );
	t.deepEqual( w, expected, 'returns expected value' );
...
tape( 'the function supports an `x` stride (accessors)', function test( t ) {
	...
	gwxsy( 3, toAccessorArray( x ), 2, 0, toAccessorArray( y ), 1, 0, toAccessorArray( w ), 1, 0 );
	t.deepEqual( w, expected, 'returns expected value' );
	t.end();
});
...
tape( 'the function supports a `y` stride (accessors)', function test( t ) {
	...
	gwxsy( 3, toAccessorArray( x ), 1, 0, toAccessorArray( y ), 2, 0, toAccessorArray( w ), 1, 0 );
	t.deepEqual( w, expected, 'returns expected value' );
	t.end();
});
...
tape( 'the function supports a `w` stride (accessors)', function test( t ) {
	...
	gwxsy( 3, toAccessorArray( x ), 1, 0, toAccessorArray( y ), 1, 0, toAccessorArray( w ), 2, 0 );
	t.deepEqual( w, expected, 'returns expected value' );
	t.end();
});
...
tape( 'the function supports negative strides', function test( t ) {
	...
	gwxsy( 3, x, -2, x.length-1, y, -1, y.length-1, w, -1, w.length-1 );
	t.deepEqual( w, expected, 'returns expected value' );
	t.end();
});
...
tape( 'the function supports negative strides (accessors)', function test( t ) {
	...
	gwxsy( 3, toAccessorArray( x ), -2, x.length-1, toAccessorArray( y ), -1, y.length-1, toAccessorArray( w ), -1, w.length-1 );
	t.deepEqual( w, expected, 'returns expected value' );
	t.end();
});
